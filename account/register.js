/*document.addEventListener("DOMContentLoaded", () => {
    ...
    closeSuccessModal.addEventListener("click", () => {
        ...
        window.location.href = "./account/login.html" // Redirect to Login page on close
    })
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                showSuccessModal() // Show modal window of successful registration
            } else {
                showEmailModal() // Registration error
